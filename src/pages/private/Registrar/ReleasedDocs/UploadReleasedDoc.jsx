...
const UploadReleasedDocs = () => {
    ...
    if (userStatus === "For Verification") {
        return (
            <>
                <h1 className="is-size-4 mb-4">Upload Released Doc</h1>
                ...
                if (ethereum) {
                    ...
                    if (receipt.status === 1) {
                        await http.post(`/api/blockchainUploadFile/`, {
                            ...
                            category: "Released Doc",
                            pid: dataId,
                            block_hash: tx.hash
                        });

                        navigate("/releasedDocs");
                    }
                } else {
                    alert(
...
export default UploadReleasedDocs;
